...
def generate_inputs(inputs_dir, outputs_dir, inputs_dir2, outputs_dir2):
	...
	for i in range(len(filelist_inputs)):
		...
		subEPIs[99, :, :, :] = np.reshape(ychannel[:, startIndex-3:startIndex+colsRemaining], (17, 17, 1))
...
def main():
	...
	input_sub_EPIs = (input_sub_EPIs-127.5)/127.5
	output_sub_EPIs = (output_sub_EPIs-127.5)/127.5
	...
	with tf.Session() as sess:
		...
		saver.save(sess, "model_-1to1/my_model50")
